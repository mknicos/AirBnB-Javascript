...
exports.sendWelcome = function(data, fn){
  send({from:'admin@mattknicos.net', to:data.to, subject:'Welcome to AirBnB', template:'welcome'}, fn);
};
...
function send(data, fn){
  ...
  var url = 'https://api:' + key + '@api.mailgun.net/v2/mattknicos.net/messages';
